...
<!--                             
	<form autocomplete="off" action="#" method="post" class="mb-48 updateprofile"> -->
                    ...
                    <input type="hidden" name="column" value="c_id"/>
                    <input type="hidden" name="table" value="customer"/>
                    <input type="hidden" name="API_NAME" value="updateprofile"/>
	                   <div class="container">
                        <div class="row">
                            <div class="col-sm-6 col-12">
                                <div class="form-group">
                                    <label class="pb-1 pb-md-0 form-label">Name <b class="req">*</b></label>
                                    <input autocomplete="off" class="form-control inputtext" id="name"  name="name" placeholder="Enter First Name" type="text" value="<?php echo $customer->name;?>" required />
                                </div>
                            </div>
							<div class="col-sm-6 col-12">
                                <div class="form-group">
                                    <label class="pb-1 pb-md-0 form-label">Email <b class="req">*</b></label>
                                    <input autocomplete="off" class="form-control inputtext" id="email"  name="email" placeholder="Enter email" type="email" value="<?php echo $customer->email;?>" required />
                                </div>
                            </div>
							<div class="col-sm-6 col-12">
                                <div class="form-group">
                                    <label class="pb-1 pb-md-0 form-label">DOB<b class="req">*</b></label>
                                    <input autocomplete="off" class="form-control" id="dob"  name="dob" placeholder="Enter dob" type="date" value="<?php echo $customer->dob;?>" required />
                                </div>
                            </div>
							<div class="col-sm-6 col-12">
                                <div class="form-group">
                                    <label class="pb-1 pb-md-0 form-label">Birth Time<b class="req">*</b></label>
                                    <input autocomplete="off" class="form-control" id="birth_time"  name="birth_time" placeholder="Enter Birth Time" type="time" value="<?php echo $customer->birth_time;?>" required />
                                </div>
                            </div>
							<div class="col-sm-6 col-12">
                                <div class="form-group">
                                    <label class="pb-1 pb-md-0 form-label">Phone <b class="req">*</b></label>
                                    <input autocomplete="off" class="form-control inputtext" id="contact"  name="contact" placeholder="Enter Phone No" type="number" value="<?php echo $customer->contact;?>" required />
                                </div>
                            </div>
                            <div class="col-sm-6 col-12">
                                <div class="form-group">
                                    <label class="pb-1 pb-md-0 form-label">Gender</label>
                                    <select class="form-control" id="gender" name="gender" required ><option value="">--Select--</option>
...
<option value="Other">Other</option>
                            ...
                            <div class="col-sm-6 col-12">
                                <div class="form-group">
                                    <label class="pb-1 pb-md-0 form-label">Marital Status</label>
                                    <select class="form-control" id="marital_status" name="marital_status" required><option  value="">--Select--</option>
...
<option value="Married">Unmarried</option>
                            ...
                            <div class="col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input autocomplete="off" class="form-control inputtext ui-autocomplete-input" id="birth_place" name="birth_place" placeholder="Enter Place Of Birth" type="text" value="<?php echo $customer->birth_place;?>" required />
                                </div>
                            </div>
							<div class="col-sm-6 col-12">
                                <div class="form-group">
                            ...
                            <div class="col-sm-6 col-6 text-center pt-4">
								...
								<button type="submit" class="btn btn-chat btn-chat-lg font-weight-bold px-5 py-2" onclick="updateprofilee()">Update Profile</button>
                                </div>
                            </div>
                        </div>
                    </div>
...
<!--end mobile code dropdown-->;
	...
	$('#marital_status').val('<?php echo $customer->marital_status;?>');
	</script>
    <script>
        function updateprofilee(){
