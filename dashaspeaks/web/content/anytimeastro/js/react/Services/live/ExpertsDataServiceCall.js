...
class ExpertsDataServiceCall {
    ...
    getFilteredAstrologers(dataitems, showFree, _currentUTCTimeStampForList) {
        ...
        if (ExpertListService) {
            ...
            if (ExpertListService.StatusCode == 200) {
                ...
                if (_SearchExpert) {
                    ...
                    olddataitems = this.getFilteredAstrologers(dataitems, false, parseInt(ServerCurrentTimeStampForList));
                    //olddataitems = dataitems;                    
                }
                else {
                    Array.prototype.push.apply(olddataitems, dataitems);
                    //do not shuffle/ do not show free - for search filter
                    olddataitems = this.getFilteredAstrologers(olddataitems, checkIfOfferAvailable(eEligibleArea.CALL), parseInt(ServerCurrentTimeStampForList));
                }
        ...
        switch (_renderBtn) {
            ...
            case "call-online":
                ...
                let jsonobj = {
                    ...
                    "expertUSDCallCharge": expertUSDCallCharge, "isFree": isFreeCall, "IsChargeOverride": config.IsChargeOverride, "ModuleOfferType": config.ModuleOfferType, "NextTimeCount": config.NextTimeCount, "NextSessionCounter": config.NextSessionCounter, "moduleofferId": config.moduleofferId, "IsHappyHour": config.IsHappyHour, "HappyHourEndTime": config.HappyHourEndTime, "updatedDiscountedprice": config.updatedDiscountedprice };
    ...
    getPsychicCard(expertdata, expertconfig) {
        ...
        try {
            //happy hour work started here
            if (expertdata.isHappyHourEnabled == 1 && _isHappyHourAvailable && !(islowpriceoffer || IsFreeCall)) {
        ...
        let itemsection1 = '<ul class="list-unstyled d-flex mb-0"><li class = "mr-3 position-relative psychic-presence status-' + expertdata.PsychicId + '" data-status="' + expertstatus + '" data-chata="' + UserCurrency + '' + expertCharge + '" data-calla="' + UserCurrency + ' ' + expertCharge + '" ><a href="javascript:void(0);" data-href="' + expertUrl + '"><div class="psyich-img position-relative"><img src="' + expertprofilepic + '" width="80" height="80" style="border-radius:50%;" loading="lazy" /></div></a>' + expertstatusbadge + '</li ><li class="w-100 overflow-hidden"><a href="javascript:void(0);" data-href="' + expertUrl + '" class="colorblack font-weight-semi-bold font16 mt-0 ml-0 mr-0 mb-0 p-0 text-capitalize d-block" data-toggle="tooltip" title="' + expertdata.DisplayName + '">' + expertdata.DisplayName + '</a><span class="font-12 d-block color-red">' + categoryName + '</span><span class="font-12 d-block exp-language">' + ExpertLanguages + '</span><span class="font-12 d-block"> ' + getLanguageKeyString("EP_Exp") + ' : ' + expertExperience + ' ' + getLanguageKeyString("EP_ExpYear") + '</span><span class="font-12 font-weight-semi-bold d-flex"> <span class="exprt-price">' + expertChargeBeforeDiscountStr +'</span> <span class="free-badge text-uppercase color-red ml-2 d-none">' + getLanguageKeyString("GLB_Free_Txt") + '</span></span></li></ul >';


        let itemsection2 = '<div class="d-flex align-items-center justify-content-between"><div class="psy-review-section" ><a href="javascript:void(0);" data-href="' + expertUrl + '"><p class="m-0 p-0 font9 nowrap review-psy">' + this.getReviews(expertdata.Rating, expertdata.ReviewCount) + '</p></a></div><div class="d-flex align-items-end position-relative"><div class="d-block">' + this.ExpertActionBtn(expertdata, { "CallChatBtnShow": CallChatBtnShow, "categoryName": CategoryId, "expertCallCharge": expertCharge, "expertUSDCallCharge": expertdata.CallCharge, "expertChargeToShow": expertChargeToShow, "UserCurrency": UserCurrency, "expertChargeType": expertChargeType, "expertlocaleurl": expertUrl, "isFreeCall": IsFreeCall, "IsChargeOverride": IsChargeOverride, "ModuleOfferType": ModuleOfferType, "NextTimeCount": NextTimeCount, "NextSessionCounter": NextSessionCounter, "moduleofferId": moduleofferId, "IsHappyHour": isHappyHourOfferAvailable, "HappyHourEndTime": happyhourEndTimestamp, "updatedDiscountedprice": updatedDiscountedprice }) + '' + this.getFreeMinuteText(isrechargeofferavailable, FreeMinutesForEligibleOffer) + '</div></div></div>';
