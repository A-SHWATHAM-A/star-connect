...
this["FirechatDefaultTemplates"]["templates/message.html"] = function (obj) {
    ...
    with (obj) {
        ...
        try {
            if (obj.hasOwnProperty("s") && typeof obj.s === "object" && obj.s != null) {
                ...
                if (obj.s.hasOwnProperty("p") && typeof obj.s.p === "object" && obj.s.img != null) {
                    ...
                    if (obj.s.hasOwnProperty("ifr") && typeof obj.s.ifr === "number" && parseFloat(obj.s.ifr) > 0) {
                        shareableItem += '<span class="font-weight-semi-bold d-flex color-red">Free</span>';
                    } else {
                ...
                if (shareableLink != "") {
                    ...
                    if (obj.s.hasOwnProperty("bt") && typeof obj.s.bt === "string" && obj.s.bt != "") {
                        shareableItem += '<a class="d-flex align-items-center justify-content-center" style="color:#0000E1" href="' + shareableLink + '" target="_blank"><img src="' + _atacommonCdnPrefix +'dashaspeaks/web/content/images/puja-share-btn.png" width="16" height="16" /> <span class="ml-1 d-flex" style="color:#0000E1">' + obj.s.bt + '</span></a>';
                    } else {
                        shareableItem += '<a class="d-flex align-items-center justify-content-center color-red" style="color:#0000E1" href="' + shareableLink + '" target="_blank"><img src="' + _atacommonCdnPrefix +'dashaspeaks/web/content/images/puja-share-btn.png" width="16" height="16" /> <span class="ml-1 d-flex" style="color:#0000E1">' + shareableLink + '</span></a>';
                    }
                    shareableItem += '</p>';
                }
                shareableItem += '</div>';
        ...
        let _msgtimestamp = getUTCTicksForServerTimestamp();
        ...
        __p += '\' data-message-id=\'' + __e(id) + '\' data-timestamp=\'' + __e(_msgtimestamp) + '\' data-user-id=\'' + __e(userId) + '\' data-user-name=\'' + __e(name) + '\' data-class="firechat-message">\n'
           /* + '</label>';*/
...
(function () {
    ...
    Firechat.prototype.sendMessage = function (roomId, messageContent, messageOriginal, messageType, fileName, fileSize, fileUrl, cb) {
        if (InChatTotalPausedSeconds != undefined && InChatTempPausedSeconds != undefined) {
            if (InChatTempPausedSeconds > 0) {
                InChatTotalPausedSeconds += InChatTempPausedSeconds;
                InChatTempPausedSeconds = 0;
            }
        }
        var self = this;
    ...
    Firechat.prototype.inviteUser = function (userId, roomId, walletBalance, expertCharge, expertUSDCharge, overridePrice, targetele, prefId, totalSecondsForSession, LastFreeChatExpertId, LastFreeChatId, callback) {
        var _UsdRate = 0;
...
(function ($) {
    ...
    FirechatUI.prototype.showMessage = function (roomId, rawMessage) {
        ...
        if (typeof (rawMessage) === 'object') {
            ...
            if (rawMessage.hasOwnProperty('lnk') && typeof rawMessage.lnk === 'boolean') {
                _gislnk = rawMessage.lnk;
            }
        ...
        if (self._user && postedByUserId != self._user.id && typeof rawMessage.ts === 'number' && parseInt(rawMessage.ts) > 0) {
            msgTimeStamp = rawMessage.ts;
        }
        ...
        if (!(self._user && postedByUserId == self._user.id)) {
            ...
            if (rawMessage.hasOwnProperty('t') && typeof (rawMessage.t) === 'number') {
                ...
                if (fileType != 11) {
                    ...
                    if (InChatDefaultCustomerDeliveryTime == null) {
                        InChatDefaultCustomerDeliveryTime = lasExpertMessageTimestamp;
                    } else {
                        InChatCustomerDeliveryTime = lasExpertMessageTimestamp;
                    }
                    firebase.database().ref("room-messages").child(roomId).child("lrt").child("lcrt").set(lasExpertMessageTimestamp);
                }
            } else {
                lasExpertMessageTimestamp = getUTCTicksForServerTimestamp();
        ...
        //in chat meta data in session storage
        setChatMetaData();
    ...
    FirechatUI.prototype.linkify = function (str, FileName) {
        var self = this;
        if (FileName === undefined && _gislnk == true) {
            return str
                .replace(self.urlPattern, '<a target="_blank" href="$&" title=' + str + '>' + str + '</a>')
