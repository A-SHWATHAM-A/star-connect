                                    ...
                                    <span class="text-white breadcrumbs">
                                        <a href="<?php echo $base_url;?>" style="color:white;text-decoration:none">
                                            <i class="fa fa-home font-18"></i>
												...
												<i class="fa fa-chevron-right"></i> <a href="<?php echo $base_url;?>/horoscope/yearly-horoscope" style="color:white;text-decoration:none">Yearly  Horoscope </a>
            ...
            <div class="col-sm-12">
                <div class="row">
                    <div class="col-8 col-md-6 d-flex align-items-center text-left">
                        <h1 class="">
                            <span class="dd-block cat-heading font-weight-semi-bold font-24 mb-0"><?php echo $hor_name != "" ?ucwords($hor_name):"Yearly Horoscope";?></span>
                        </h1>
    ...
    <div class="container">
        <div class="row py-3">
            <div class="col-12 col-md-12 mt-4 cat-pages-hide">
               <h2 class="cat-heading mb-4">Your Yearly <span class="color-red">Horoscope</span></h2>
                <p class="text-center">Are you worried about where you will be by the end of this year in various aspects of your life? Or how will this year turn out to be for you? Then click on your Zodiac sign below and gain the best insights into the year with your detailed Yearly Horoscope.</p>

                <div class="row pt-4">
                    <div class="col-4 col-md-4 col-lg-3 col-xl-2 mb-4">
                        <div class="shadow-pink-down text-center p-3 hover-border-red rounded-10">
                            <a href="<?php echo $base_url;?>/horoscope/yearly-horoscope/aries-yearly-horoscope" title="Aries Daily Horoscope" class="text-decoration-none text-dark">
                                <div>
                    ...
                    <div class="col-4 col-md-4 col-lg-3 col-xl-2 mb-4">
                        <div class="shadow-pink-down text-center p-3 hover-border-red rounded-10">
                            <a href="<?php echo $base_url;?>/horoscope/yearly-horoscope/taurus-yearly-horoscope" title="Taurus Daily Horoscope" class="text-decoration-none text-dark">
                                <div>
                    ...
                    <div class="col-4 col-md-4 col-lg-3 col-xl-2 mb-4">
                        <div class="shadow-pink-down text-center p-3 hover-border-red rounded-10">
                            <a href="<?php echo $base_url;?>/horoscope/yearly-horoscope/gemini-yearly-horoscope" title="Gemini Daily Horoscope" class="text-decoration-none text-dark">
                                <div>
                    ...
                    <div class="col-4 col-md-4 col-lg-3 col-xl-2 mb-4">
                        <div class="shadow-pink-down text-center p-3 hover-border-red rounded-10">
                            <a href="<?php echo $base_url;?>/horoscope/yearly-horoscope/cancer-yearly-horoscope" title="Cancer Daily Horoscope" class="text-decoration-none text-dark">
                                <div>
                    ...
                    <div class="col-4 col-md-4 col-lg-3 col-xl-2 mb-4">
                        <div class="shadow-pink-down text-center p-3 hover-border-red rounded-10">
                            <a href="<?php echo $base_url;?>/horoscope/yearly-horoscope/leo-yearly-horoscope" title="Leo Daily Horoscope" class="text-decoration-none text-dark">
                                <div>
                    ...
                    <div class="col-4 col-md-4 col-lg-3 col-xl-2 mb-4">
                        <div class="shadow-pink-down text-center p-3 hover-border-red rounded-10">
                            <a href="<?php echo $base_url;?>/horoscope/yearly-horoscope/virgo-yearly-horoscope" title="Virgo Daily Horoscope" class="text-decoration-none text-dark">
                                <div>
                    ...
                    <div class="col-4 col-md-4 col-lg-3 col-xl-2 mb-4">
                        <div class="shadow-pink-down text-center p-3 hover-border-red rounded-10">
                            <a href="<?php echo $base_url;?>/horoscope/yearly-horoscope/libra-yearly-horoscope" title="Libra Daily Horoscope" class="text-decoration-none text-dark">
                                <div>
                    ...
                    <div class="col-4 col-md-4 col-lg-3 col-xl-2 mb-4">
                        <div class="shadow-pink-down text-center p-3 hover-border-red rounded-10">
                            <a href="<?php echo $base_url;?>/horoscope/yearly-horoscope/scorpio-yearly-horoscope" title="Scorpio Daily Horoscope" class="text-decoration-none text-dark">
                                <div>
                    ...
                    <div class="col-4 col-md-4 col-lg-3 col-xl-2 mb-4">
                        <div class="shadow-pink-down text-center p-3 hover-border-red rounded-10">
                            <a href="<?php echo $base_url;?>/horoscope/yearly-horoscope/sagittarius-yearly-horoscope" title="Sagittarius Daily Horoscope" class="text-decoration-none text-dark">
                                <div>
                    ...
                    <div class="col-4 col-md-4 col-lg-3 col-xl-2 mb-4">
                        <div class="shadow-pink-down text-center p-3 hover-border-red rounded-10">
                            <a href="<?php echo $base_url;?>/horoscope/yearly-horoscope/capricorn-yearly-horoscope" title="Capricorn Daily Horoscope" class="text-decoration-none text-dark">
                                <div>
                    ...
                    <div class="col-4 col-md-4 col-lg-3 col-xl-2 mb-4">
                        <div class="shadow-pink-down text-center p-3 hover-border-red rounded-10">
                            <a href="<?php echo $base_url;?>/horoscope/yearly-horoscope/aquarius-yearly-horoscope" title="Aquarius Daily Horoscope" class="text-decoration-none text-dark">
                                <div>
                    ...
                    <div class="col-4 col-md-4 col-lg-3 col-xl-2 mb-4">
                        <div class="shadow-pink-down text-center p-3 hover-border-red rounded-10">
                            <a href="<?php echo $base_url;?>/horoscope/yearly-horoscope/pisces-yearly-horoscope" title="Pisces Daily Horoscope" class="text-decoration-none text-dark">
                                <div>
...
<div class="row">
	<div class="col-sm-12">
            <h2 class="heading text-center">Why Should You Check Your Yearly Horoscope?</h2><p>The life of an individual is divided into phases where they do certain things on a daily basis, weekly basis, monthly basis, and yearly basis. The nature of these decisions and events varies significantly. When it comes to the whole year it’s a long time that can significantly impact your life. So here the Yearly Horoscope can predict the best and the worst times that one can expect throughout the year according to which they can plan the most important aspects of their lives in such a way that they can prove to be the most rewarding.</p><p>When you know the overall vibe or theme of how your year will be, it becomes more convenient to get through the ups and downs. The Yearly Horoscope is mostly created to know about the financial status. However, it can also provide insights into other aspects of one’s life like love, career, business, success, etc. Whenever you need to plan something for the long term then Yearly Horoscopes can prove to be very beneficial.</p><p>The predictions of Yearly Horoscopes are not set in stone and with proper remedies and Astrological guidance, the impact of any adversities can be minimized. This is where it becomes essential to consult only the best Astrologers to gain the most meaningful insights.</p><p>So click on your zodiac sign below and get ready to make the most of your life by utilizing the best that you will be blessed with and being careful about the challenges that could come your way!</p>
        </div>
    </div>
</div>
