            ...
            <div class="col-md-12 d-flex align-items-center">
                <span style="text-transform: capitalize; ">
                    <span class="text-white breadcrumbs">
                        ...
                        <i class="fa fa-chevron-right"></i> <span class="breadcrumbtext">User Login</span>
                    </span>
                </span>
            </div>
        </div>
            ...
            <div class="row pt-3 pb-lg-5">
                <div class="col-lg-6 col-12 order-lg-1">
                    <div id="step1" class="categorycontent step-1 sychics-join-form position-relative border px-4 pb-4">
                        <h2 class="py-3 text-center"><small class="font-weight-bold">User Sign In</small></h2>
                        <a href="<?php echo $base_url; ?>/register">Don't have account?</a><br /><br />
                        <form autocomplete="off" action="#" method="post" class="mb-48 loginform login-validation-123">
                            <input type="hidden" name="API_NAME" value="login" />
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="Name">Email/Mobile No<span class="color-red font-weight-bold">*</span></label>
                                    <input autocomplete="new-password" type="text" name="email" required class="form-control rounded" />
                                </div>
                                <div class="col-md-6 mb-3">
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="Name">Type<span class="color-red font-weight-bold">*</span></label>
                                    <select name="table" class="form-control">
                                        <option value="customer">User</option>
                                        <option value="profile">Astrologer</option>
                                    </select>
                                </div>
                                <div class="col-md-6 text-center">
                                    <button type="submit" class="btn btn-chat btn-chat-lg font-weight-bold px-5 py-2">Sign In</button>
