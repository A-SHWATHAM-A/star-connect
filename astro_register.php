...
<style>
    ...
    .sychics-join-form input.form-control, .sychics-join-form select.form-control {
        border-color: #FFD4D8;
        height: 35px;
        line-height: 35px;
        color: rgba(25, 25, 25, 0.5);
    ...
    .sychics-join-form .form-control:focus, #astOtpModel .form-control:focus {
        box-shadow: none;
        border-color: #EE4E5E;
    }
    ...
    .sychics-join-form:before, .sychics-join-form:after {
        content: "";
    ...
    #ExpertSignupDoneModal .close {
        ...
        #ExpertSignupDoneModal .close:hover, #ExpertSignupDoneModal .close:focus, #ExpertSignupDoneModal .close:active {
            color: #000 !important;
            outline: 0;
        ...
        <div class="row pt-3 pb-lg-5">
            <div class="col-lg-6 col-12 order-lg-1">
                <div id="step1" class="categorycontent step-1 sychics-join-form position-relative border px-4 pb-4">
                    ...
                    <input type="hidden" name="API_NAME" value="astrologer_register"/>
					<div class="row">
						...
						<div class="col-6 mb-3">
                            <label for="Name">Age<span class="color-red font-weight-bold">*</span></label>
                            <input type="number" name="age" id="age" required class="form-control rounded">
                        </div>
						<div class="col-6">
